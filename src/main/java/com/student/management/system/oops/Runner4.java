...
public class Runner4 {
	...
	public static void main(String[] args) {
		...
		if (file.exists()) {
			...
			System.out.println("How many student info you would like to enter?");
			int studentIndex = scanner.nextInt();

			Student[] studentArray = new Student[studentIndex];
			scanner.nextLine();
			...
			for (int i = 0; i < studentArray.length; i++) {
				...
				if (isSportStudent.equalsIgnoreCase("yes")) {
					...
					studentArray[i] = new SportStudent.SportStudentBuilder(studentName, studentAge, parentContactNumber,
					...
					studentArray[i] = new RegularStudent.RegularStudentBuilder(studentName, studentAge,
